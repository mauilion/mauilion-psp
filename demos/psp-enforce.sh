...
p "Now let's try to deploy some of the r00t pod with a the restrictive psp policy in place."
pe "kubectl apply -n secure -f k8s_root/r00t.yaml  --as system:serviceaccount:secure:default"
